      ...
      body: Consumer<HomePageController>(
        builder: (context, data, child) {
          ...
          Positioned(
            ...
            backgroundColor:_currentIndex ==0 ? ColorData.themeColor:   ColorData.themeColor,
            extras: {"label": "home"}),
            FluidNavBarIcon(
            unselectedForegroundColor: ColorData.secondaryColor,
            // unselectedForegroundColor: Colors.red,
            icon: Icons.notifications,
            backgroundColor:_currentIndex ==1 ? ColorData.themeColor:   ColorData.themeColor,
            extras: {"label": "bookmark"}),
            FluidNavBarIcon(
            unselectedForegroundColor: ColorData.secondaryColor,
            icon: Icons.forum,
            backgroundColor:_currentIndex ==2 ? ColorData.themeColor:   ColorData.themeColor,
            extras: {"label": "partner"}),
            FluidNavBarIcon(
            unselectedForegroundColor: ColorData.secondaryColor,
            // svgPath: "assets/conference.svg",
            icon: Icons.newspaper,
            backgroundColor:_currentIndex == 3? ColorData.themeColor:   ColorData.themeColor,
            extras: {"label": "conference"}),
            FluidNavBarIcon(
            unselectedForegroundColor: ColorData.secondaryColor,
            // svgPath: "assets/conference.svg",
            icon: Icons.person,
            backgroundColor:_currentIndex ==4? ColorData.themeColor:   ColorData.themeColor,
            extras: {"label": "conference"}),
            ],
            onChange: (index) {
            setState(() {
